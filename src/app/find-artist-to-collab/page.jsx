...
const page = () => {
  return (
   <>
         ...
         <main className="bg-[#f4f3ee] min-h-screen px-4 md:px-9 lg:px-12 py-10">
           <div className="max-w-5xl mx-auto flex flex-col gap-6">
             ...
             <div className="text-left">
               <h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Find Artists to Collaborate</h1>
      </div>
      <FindGigsSearchBar/>
      <Dropdowns/>
      <FindArtistsCards/>
    ...
    <NoGigsFound heading={"No artists found"} para={"Try adjusting your search or filters to find artists that match your criteria."}/>
    </main>
    </>
  )
}
