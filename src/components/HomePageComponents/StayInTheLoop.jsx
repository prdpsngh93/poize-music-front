...
export default function StayInTheLoop() {
 ...
 <div className="relative h-[500px] bg-[url('/images/bg-image.png')] bg-cover bg-center rounded-xl text-white text-center flex flex-col items-center justify-center px-4 overflow-hidden">
