...
const MusicLoverDashboard = () => {
  ...
  const venues = [
    ...
    },
    {
      image: "/images/upcominggig1.png",
      name: "The Garage",
      role: "Local bands showcase",
    },
    {
      image: "/images/upcominggig3.png",
      name: "Central Park",
      role: "Outdoor music events",
    },
    {
      image: "/images/upcominggig2.png",
      name: "The Blue Note",
  ...
  const notifications = [
    {
      image: "/images/upcominggig1.png",
      title: "The Indie Rockers",
      message: "New album just dropped!",
    },
    {
      image: "/images/upcominggig1.png",
      title: "The Pop Sensations",
      message: "Live concert confirmed!",
    },
  ];
          ...
          <div className="flex flex-col gap-4">
            {notifications.map((item, idx) => (
              ...
              >
                ...
                />
                <div>
                  <h4 className="font-medium text-sm text-[#121417]">
                    {item.title}
                  </h4>
