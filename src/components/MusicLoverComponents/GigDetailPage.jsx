  ...
  return (
    <main className="bg-[#f4f3ee] min-h-screen px-4 md:px-9 lg:px-12 py-10">
      <div className="max-w-5xl mx-auto flex flex-col gap-10">
        ...
        <img
          src="/images/gig-detail-main.png"
          alt="Gig"
        ...
        <div className="space-y-4">
          {/* Title & Subtitle */}
          <div>
            <h2 className="text-lg md:text-xl font-semibold text-[#121417]">
              Indie Rock Night
            </h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3 items-start">
              ...
              <button className="bg-[#5925DC] text-white rounded-full px-4 py-2 text-sm font-medium">
                RSVP
              </button>
            </div>
            ...
            <button className="bg-[#12B76A] text-white rounded-full px-4 py-1.5 text-sm font-medium">
              Save
            </button>
          </div>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-[#475467] leading-relaxed">
              Get ready for an electrifying night of indie rock with three of
              the hottest up-and-coming bands in the scene.
              <span className="font-medium"> The Sonic Waves</span> will kick
              things off with their high-energy anthems, followed by{" "}
              <span className="font-medium">Electric Echoes'</span> mesmerizing
              soundscapes, and
              <span className="font-medium"> Velvet Rhythms</span> will close
              out the night with their soulful melodies. This is a night you
              won’t want to miss!
            </p>
          </section>
        ...
        <section className="space-y-6">
          <section className="space-y-2">
            ...
            <p className="text-sm text-[#475467] leading-relaxed">
              The Echo Chamber is a legendary venue known for its intimate
              atmosphere and top-notch sound system. It's the perfect place to
              experience live music up close and personal.
            </p>
          </section>
